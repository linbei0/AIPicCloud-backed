...
import com.aipiccloud.api.imagesearch.ImageSearchApiFacade;
import com.aipiccloud.api.imagesearch.model.ImageSearchResult;
...
import com.aipiccloud.manager.auth.StpKit;
import com.aipiccloud.manager.auth.annotation.SaSpaceCheckPermission;
import com.aipiccloud.manager.auth.model.SpaceUserPermissionConstant;
...
import com.aipiccloud.model.vo.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        long size = pictureQueryRequest.getPageSize();
        // 限制爬虫
        ThrowUtils.throwIf(size > 48, ErrorCode.PARAMS_ERROR);
        // 空间权限校验
