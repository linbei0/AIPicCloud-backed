package com.aipiccloud.service.impl;
...
import com.aipiccloud.api.aliyunai.AliYunAiApi;
...
import com.aipiccloud.manager.upload.UrlPictureUpload;
import com.aipiccloud.mapper.PictureMapper;
import com.aipiccloud.model.dto.file.UploadPictureResult;
import com.aipiccloud.model.dto.picture.*;
import com.aipiccloud.model.entity.Picture;
import com.aipiccloud.model.entity.Space;
import com.aipiccloud.model.entity.User;
import com.aipiccloud.model.enums.PictureReviewStatusEnum;
import com.aipiccloud.model.vo.PictureVO;
import com.aipiccloud.model.vo.UserVO;
import com.aipiccloud.service.PictureService;
import com.aipiccloud.service.SpaceService;
import com.aipiccloud.service.UserService;
import com.aipiccloud.utils.ColorSimilarUtils;
import com.aipiccloud.utils.FetchImageUrls;
import com.aipiccloud.utils.HexColorExpander;
...
//            }
        ...
        // TODO 如果是更新，可以删除对象存储的旧图片，如果是私人空间图片同时更新空间额度
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        int source = pictureUploadByBatchRequest.getSource();
        ...
        switch (source) {
            case 0: // Bing搜索源
                imageUrls = FetchImageUrls.FromBing(searchText);
                break;
            case 1: // Pexels搜索源
                imageUrls = FetchImageUrls.FormPexels(searchText, count,pexelsApiKey);
                break;
            default:
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "不支持的图片搜索源");
        }
    ...
    public CreateOutPaintingTaskResponse createPictureOutPaintingTask(CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, User loginUser) {
        ...
        if (picture.getPicWidth() < 512 || picture.getPicWidth() > 4096 || picture.getPicHeight() < 512 || picture.getPicHeight() > 4096) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "图像分辨率不合规");
        }
        // 权限校验，已改为使用注解鉴权
